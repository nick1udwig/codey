...
var cases = ["native_test", "delivery_retry_test", "element_test", "schedules_test", "answer_notification_test", "watch_response_test", "control_test", "touch_guard_test", "gesture_controller_test", "refresh_policy_test", "ripple_test", "timeline_test", "artwork_cache_test"];
...
var compile = childProcess.spawnSync("cc", [
  ...
  path.join(root, "src", "c", "delivery_retry.c"),
  path.join(root, "src", "c", "agent_ui_element.c"),
  ...
  path.join(root, "src", "c", "capabilities", "collections.c"),
